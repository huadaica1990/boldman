...
(function ($) {
	...
	$.fn.themePin = function (options) {
		...
		this.each(function () {
			...
			$( "img", this ).one( "load", function () {
				if ( r_timer ) {
					Ecsgroup.deleteTimeout( r_timer );
				}
				r_timer = Ecsgroup.requestTimeout( recalculateLimits, 20 );
			} );
			data.update = update;
	...
	Sticky.prototype = {
		...
		build: function () {
			...
			setTimeout(function() {
				if ( typeof Ecsgroup.sticky_top_height != 'undefined' && $el.data('themePin').pad ) {
					$el.data('themePin').pad.top = Ecsgroup.sticky_top_height;
				}
			}, 300);
